    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                ...
                <a href="<?php echo SERVERURL; ?>estudio-social-new/">Nuevo estudio social <span class="fa-angle-right fa"></span></a>
                <a href="<?php echo SERVERURL; ?>estudio-social-list/">Lista de estudio sociales <span class="fa-angle-right fa"></span></a>
                <a class="active" href="<?php echo SERVERURL; ?>estudio-social-search/">Buscar estudio social <span class="fa-angle-right fa"></span></a>
            </p>
        </div>
    </div>
</div>
...
<?php
if (!isset($_SESSION['busqueda_estudio']) && empty($_SESSION['busqueda_estudio'])) {
//el empty() para saber si esta vacia y el isset() para saber si esta definida
    ?>
        ...
        <form class="cmxform FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
            <input type="hidden" name="modulo" value="estudio">
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="form-group form-animate-text">
                            ...
                            <span class="bar"></span>
                            <label for="inputSearch" class="bmd-label-floating text-center">¿Qué estudio estas buscando?</label>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>"<?php echo $_SESSION['busqueda_estudio']; ?>"</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        ...
        echo $ins_estudio->paginador_estudio_controlador($pagina[1], 10, $_SESSION['privilegio_tor'], $pagina[0], $_SESSION['busqueda_estudio']);
        ?>
    </div>
