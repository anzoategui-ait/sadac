    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                ...
                <a  class="active" href="<?php echo SERVERURL; ?>estudio-social-list/">Lista de estudio sociales <span class="fa-angle-right fa"></span></a>
...
echo $ins_estudio->paginador_estudio_controlador($pagina[1], 10, $_SESSION['privilegio_tor'], $pagina[0], "");
?>
</div>
