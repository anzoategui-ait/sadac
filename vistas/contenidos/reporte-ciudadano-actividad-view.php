...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Reportes / Ciudadanos vs Actividades</h3>
            <p class="animated fadeInDown">
                Totalizacion de las actividades dentro de un rango, seleccionando una usuario, todas o una actividad en especifico, el formato final es de tipo .pdf.
            </p>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <form class="form-neon" action="<?php echo SERVERURL; ?>reporte/reporteciudadanoactividad.php" method="POST" data-form="save" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="actividad_estado" class="bmd-label-floating" style="color:#1F618D;"><b>CIUDADANOS</b></label>
                             <select class="form-control" name="ciudadano_id" id="ciudadano_id" required="">
                                <option value="<?php echo $ins_ciudadano->encryption(0);?>" selected="">Todos</option>
                                <!-- Obtener todas las encuestas registradas en el sistema -->
                                <?php
                                                                
                                $rs_ciudadano = $ins_ciudadano->datos_usuario_controlador("Ciudadano", 0);
                                if($rs_ciudadano->rowCount()>0){
                                    $datos_ciudadanos = $rs_ciudadano->fetchAll();
                                    
                                    foreach($datos_ciudadanos as $rows){
                                        echo '<option value="'.$ins_ciudadano->encryption($rows['usuario_id']).'">'.$rows['usuario_nombre']. '</option>';
                                    }
                                }
                                ?>
