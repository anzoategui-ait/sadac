    ...
    <?php
		...
		if($vistas=="login" || $vistas=="404" || $vistas=="login-club"){
                   ...
                   if(!isset($_SESSION['token_tor']) || !isset($_SESSION['usuario_tor']) || !isset($_SESSION['privilegio_tor']) || !isset($_SESSION['id_tor'])){
                       if($vistas!="./vistas/contenidos/solicitud-view.php" && $vistas!="./vistas/contenidos/consulta-view.php" && $vistas!="./vistas/contenidos/requisitos-view.php" && $vistas!="./vistas/contenidos/turno-public-view.php"){
